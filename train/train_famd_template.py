...
TEST_SIZE  = 0.2                
VAL_SIZE   = 0.15              
MODEL_SAVE_PATH = "multiview_famd_pipeline.pkl"  
...
for core_name, feat_list in CORE_FEATURES.items():
    ...
    print(f"  Core {core_name:<12} -> Explained Variance (1st Component): {explained_variance[0]:.2f}%")
    
    # Chuyển đổi dữ liệu sang không gian 1 chiều
...
# =============================================================
# 7. SAVE COMPLETE FAMD PIPELINE
# =============================================================
print("\n" + "=" * 60)
print("  SAVING PIPELINE WITH BEST MODEL")
print("=" * 60)

joblib.dump(
    {
        "famd_transformers": famd_transformers,  
        "meta_model": best_info["model_object"],  
        "target_encoder": le_target,
        "core_features": CORE_FEATURES
    },
    MODEL_SAVE_PATH
)
print(f"FAMD stacked pipeline successfully saved to '{MODEL_SAVE_PATH}'!")

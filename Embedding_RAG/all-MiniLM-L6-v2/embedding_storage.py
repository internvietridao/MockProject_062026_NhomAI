    ...
    try:
        ...
        if RESET_DB:
            try:
                ...
                logging.info(f"RESET_DB is True: Deleted existing collection '{COLLECTION_NAME}' to reload data fresh.")
            except Exception:
                pass
        ...
        logging.info(f"Accessing collection: '{COLLECTION_NAME}' (Cosine distance)")
        ...
        store_chunks_in_chroma(chunks_data, collection, BATCH_SIZE)
